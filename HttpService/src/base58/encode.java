 ...
 * @author g
 */
public class encode implements HttpHandler {
    @Override
        public void handle(HttpExchange httpExchange) throws IOException {
            try {
                ...
                String response = encodeBase58(requestBody);
    ...
    public String encodeBase58(String stringIn) {
        try {
            byte[] byteIn = stringIn.getBytes();
            String stringBase58 = Base58.encode(byteIn);
            return stringBase58;
        } catch (Exception e) { throw new RuntimeException(e); }       
    }
